...
const contacts: Contact[] = [
  { id: "c1", name: "Maria Souza", phone: "+55 11 98765-4321", instagram: "@mariasouza", email: "maria@email.com", tags: ["VIP", "ESTÉTICA"], createdAt: new Date("2026-01-15") },
  { id: "c2", name: "João Silva", phone: "+55 21 91234-5678", instagram: "@joaosilva", email: "joao@email.com", tags: ["ENTREGADOR", "MANDA JÁ"], createdAt: new Date("2026-01-20") },
  { id: "c3", name: "Ana Costa", phone: "+55 31 99876-5432", tags: ["CLIENTE REATIVAÇÃO"], createdAt: new Date("2026-02-01") },
  { id: "c4", name: "Carlos Oliveira", phone: "+55 11 97654-3210", instagram: "@carlosoliv", email: "carlos@manda.com", tags: ["ENTREGADOR", "MANDA JÁ"], createdAt: new Date("2026-02-05") },
  { id: "c5", name: "Beatriz Lima", phone: "+55 21 98765-1234", email: "bia@estetica.com", tags: ["ESTÉTICA", "VIP"], createdAt: new Date("2026-02-10") },
  { id: "c6", name: "Diego Ferreira", phone: "+55 41 99999-8888", tags: ["LEAD QUENTE"], createdAt: new Date("2026-02-15") },
  ...
  { id: "c9", name: "Helena Ribeiro", phone: "+55 11 95555-6666", instagram: "@helenarib", tags: ["VIP", "MANDA JÁ"], createdAt: new Date("2026-03-05") },
...
export function exportContactsToCSV(): string {
  const header = "Nome,Telefone,Instagram,Email,Etiquetas";
  const rows = contacts.map(
    (c) => `${c.name},${c.phone},${c.instagram || ""},${c.email || ""},${c.tags.join(";")}`
  );
